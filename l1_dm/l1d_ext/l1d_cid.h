...
#define  IS_HYPER_SLEEP_MODE_CHIP             ((IS_CHIP_MT6238_SER || IS_CHIP_MT6516 || IS_CHIP_MT6268B || IS_CHIP_MT6253 || IS_CHIP_MT6236 || IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260) && !defined(MT6516_S00) )
...
#define  IS_USC_CHIP                          ( IS_CHIP_MT6268B || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6270A) || IS_CHIP_MT6268H || IS_CHIP_MT6250 || IS_CHIP_MT6260 )
/* For Support Centralized Sleep Mode Manager Group */
#define  IS_CENTRALIZED_SMM_CHIP              ( IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6250 || IS_CHIP_MT6260 )
...
#define  IS_BSI_REG_32_BIT_CHIP               ( IS_CHIP_MT6268T || IS_CHIP_MT6268 || IS_CHIP_MT6268H || IS_CHIP_SER(CHIP_ID_MT6270A) || IS_CHIP_MT6250 || IS_CHIP_MT6260 )
...
#if IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#if IS_65NM_CHIP
   #if IS_CHIP_MT6268 || IS_CHIP_MT6516 || IS_CHIP_MT6236 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6251 || IS_CHIP_MT6575 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
      #if defined(MT6516_S00) || IS_CHIP_MT6251_S00 || IS_CHIP_MT6256_S00
#define IS_MD2G_PWD_SUPPORT                        0
      #else
#define IS_MD2G_PWD_SUPPORT                        1
      #endif
      #if IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#define IS_IRDBG_LOG_STATUS                        1
   ...
   #if IS_CHIP_MT6268 || IS_CHIP_MT6516 || IS_CHIP_MT6236 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6251 || IS_CHIP_MT6575 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 //Later chip should apply new control flow
...
#define IS_MPLLFH_FREE_RUN_SUPPORT_CHIP            0
   ...
   #if IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#if IS_CHIP_MT6251 || IS_CHIP_MT6252 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#if IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#if IS_EDGE_SAIC_CHIP_MT6236_AND_LATTER_VERSION && !(IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260)
...
#if IS_RF_MT6256RF || IS_RF_MT6251RF || IS_RF_MT6252RF || IS_RF_MT6255RF || IS_RF_MT6162 || IS_RF_MT6250RF || IS_RF_MT6260RF
...
#define IS_W_CANCELLATION_SUPPORT                  1
   #endif
#elif IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
#define IS_MT6251_DCR_MODE                         0
#define IS_MT6256_DCR_MODE                         0
#define IS_W_CANCELLATION_SUPPORT                  1
#define IS_MT6251_E1_FT                            0
...
#if IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#define IS_BSI_V1_SUPPORT                          (!IS_BSI_V2_SUPPORT)
   ...
   #if IS_CHIP_MT6256 || IS_CHIP_MT6252 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
#if IS_RF_AD6548 || IS_RF_MT6139B || IS_RF_MT6139C || IS_RF_MT6139E || IS_RF_MTKSOC1 || IS_RF_MT6252RF || IS_RF_MT6251RF || IS_RF_MT6255RF || IS_RF_MT6250RF || IS_RF_MT6260RF
...
#if IS_RF_MT6252RF || IS_RF_MT6251RF || IS_RF_MT6256RF || IS_RF_MT6255RF || IS_RF_MT6162 || IS_RF_MT6250RF || IS_RF_MT6260RF
...
#if IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
...
/*===================================================================*/
/* Compile options for MT6260RF 1st phone call and debug mode        */
/*===================================================================*/

#if IS_CHIP_MT6260
#define IS_MT6260_FIRST_PHONE_CALL_LOAD  1
#else
#define IS_MT6260_FIRST_PHONE_CALL_LOAD  0
#endif

#if IS_MT6260_FIRST_PHONE_CALL_LOAD
...
#define MT6260_DEBUG_MODE                           0

#if MT6260_DEBUG_MODE 
#define MT6260_BSIRB_DEBUG                          0
#define MT6260_BSI_DEBUG                            0
#define MT6260_AUXOUT_DEBUG                         0
#define MT6260_RXIQ_DEBUG                           0
#define MT6260_RXADC_DEBUG                          0
#define MT6260_26MCLKOUT_DEBUG                      0
#endif
...
/*              CHIP ZIMAGE setting                                  */
/*===================================================================*/
#if IS_CHIP_MT6252 || IS_CHIP_MT6250 || IS_CHIP_MT6260
...
// default value
/* ------------------------------------------------------------- */
#if IS_CHIP_MT6205 || IS_CHIP_MT6225 || IS_CHIP_MT6223 || IS_CHIP_MT6238_SER || IS_CHIP_MT6276 || IS_CHIP_MT6251 || IS_CHIP_MT6573 || IS_CHIP_MT6252 || IS_CHIP_MT6256 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
#define INTERNCODE_DEFAULT                         INTERN_NULL
#else
#define INTERNCODE_DEFAULT                         INTERN_FULL
#endif
/* ------------------------------------------------------------- */
#if IS_CHIP_MT6205 || IS_CHIP_MT6225 || IS_CHIP_MT6223 || IS_CHIP_MT6238_SER || IS_CHIP_MT6276 || IS_CHIP_MT6253 || IS_CHIP_MT6251  || IS_CHIP_MT6573 || IS_CHIP_MT6256 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260
