...
void bt_avrcp_send_version_ind( module_type dst_mod_id, kal_uint8 chnl_num, kal_uint16 result, bt_avrcp_dev_addr_struct* device_addr, kal_uint16 version, kal_uint16 Feature);
#endif
