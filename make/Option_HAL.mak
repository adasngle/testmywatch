...
MP4_SW_CODEC_V2_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6253 MT6253T MT6253E MT6253L MT6256 MT6276 MT6252 MT6252H MT6921 MT6255 MT6922 MT6250 MT6260
...
H264_SW_CODEC_V2_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6253 MT6253E MT6253L MT6253T MT6256 MT6276 MT6252 MT6252H MT6921 MT6255 MT6922 MT6250 MT6260
...
H264ENC_SW_CODEC_V2_PLATFORM = MT6276 MT6256 MT6255 MT6922
...
# RM_DECODE
RV_SW_CODEC_V2_PLATFORM = MT6236 MT6236B MT6253 MT6253E MT6253L MT6253T MT6276 MT6252 MT6252H MT6921 MT6256 MT6235 MT6255 MT6922 MT6250 MT6260
...
# SENSOR_TYPE
RAW_SENSOR_NOT_SUPPORT_PLATFORM = MT6223 MT6223P MT6205B MT6225 MT6235 MT6235B MT6255 MT6256 MT6250 MT6260
...
SERIAL_IF_V1_PLATFORM = MT6253E MT6253L MT6252 MT6252H MT6256 MT6276 MT6255 MT6922 MT6250 MT6260
...
DUMMY_SCATTER_ENABLE_PLATFORM = MT6252 MT6250 MT6260
...
NEED_ADD_PMIC_COMPILE_LIST = MT6223PMU MT6238PMU MT6235PMU MT6236PMU MT6573PMU MT6305 MT6318 MT6326 MT6253PMU MT6253ELPMU MT6252PMU MT6326_CCCI MT6251PMU MT6276PMU MT6256PMU MT6921PMU MT6255PMU MT6922PMU MT6250PMU MT6260PMU
...
CUSTOM_TOOL_IF_SUPPORTED_PMIC = MT6236PMU MT6256PMU MT6276PMU MT6251PMU MT6921PMU MT6255PMU MT6922PMU MT6250PMU MT6260PMU
...
ifdef MULTI_LEVEL_BACKLIGHT_SUPPORT
  ifeq ($(strip $(MULTI_LEVEL_BACKLIGHT_SUPPORT)),TRUE)
    MULTI_LEVEL_BACKLIGHT_SUPPORT_PLATFORM = MT6236 MT6268 MT6256 MT6276 MT6255 MT6922 MT6250 MT6260
...
ifdef NAND_FLASH_BOOTING
  ifneq ($(strip $(NAND_FLASH_BOOTING)),NONE)
    NAND_FLASH_BOOTING_SUPPORT_PLATFORM = MT6228 MT6229 MT6225 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 MT6270A MT6256 MT6276 MT6573 MT6921 MT6255 MT6922 MT6260
...
ifeq ($(strip $(USB_SUPPORT)),TRUE)
  USB_SUPPORT_PLATFORM = MT6217 MT6218B MT6219 MT6228 MT6229 MT6230 MT6227 MT6226 MT6226M MT6225 MT6252 MT6252H MT6253T MT6253 MT6253E MT6253L MT6227D MT6226D MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 MT6516 MT6270A MT6256 MT6276 MT6573 MT6251 MT6921 MT6255 MT6922 MT6250 MT6260
...
BROM_USB_DOWNLOAD_SUPPORT_PLATFORM = MT6251 MT6252H MT6252 MT6256 MT6250 MT6255 MT6260
BROM_USB_DOWNLOAD_V2_PLATFORM = MT6250 MT6260
...
ifdef USB_DOWNLOAD_IN_BL
  ifneq ($(strip $(USB_DOWNLOAD_IN_BL)),NONE)
    ifeq ($(strip $(USB_SUPPORT)),TRUE)
      USB_DOWNLOAD_SUPPORT_PLATFORM = MT6227 MT6226 MT6226M MT6227D MT6226D MT6225 MT6253T MT6253 MT6253E MT6253L MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268A MT6268 MT6270A MT6256 MT6276 MT6573 MT6252 MT6252H MT6251 MT6921 MT6255 MT6922 MT6250 MT6260
...
ifdef AMRWB_DECODE
  ifeq ($(strip $(AMRWB_DECODE)),TRUE)
    AMRWB_DECODE_NOT_SUPPORT_PLATFORM = MT6205B MT6218 MT6208 MT6218B MT6217 MT6223 MT6223P MT6253E MT6253L MT6252 MT6252H MT6250 MT6260
...
ifdef AMRWB_ENCODE
  ifeq ($(strip $(AMRWB_ENCODE)),TRUE)
    AMRWB_ENCODE_NOT_SUPPORT_PLATFORM = MT6205B MT6218 MT6208 MT6218B MT6217 MT6223 MT6223P MT6253E MT6253L MT6252 MT6252H MT6250 MT6260
...
LCD_COLOR_ENGINE_SUPPORT_PLATFORM = MT6260
...
MJPG_SUPPORT_EXT_CAM_MODULE_DEP_PLATFORM = MT6217 MT6218B MT6225 MT6253T MT6253 MT6253E MT6253L MT6235 MT6235B MT6236 MT6236B MT6223P MT6252 MT6252H MT6276 MT6921 MT6256 MT6255 MT6922 MT6250 MT6260
...
MJPEG_SW_CODEC_V2_PLATFORM = MT6253 MT6253E MT6253L MT6253T MT6236 MT6235 MT6235B MT6276 MT6252 MT6252H MT6921 MT6256 MT6255 MT6922 MT6250 MT6260
...
ifdef MJPG_DECODE_MODE
  ifeq ($(strip $(MJPG_DECODE)),TRUE)
    ifeq ($(strip $(MJPG_DECODE_MODE)),SLIM)
      MJPG_DECODE_MODE_SLIM_SUPPORT_PLATFORM = MT6276 MT6250 MT6260
...
CAMCORDER_LOW_END_SUPPORT_PLATFORM = MT6235 MT6235B MT6253 MT6253T MT6253E MT6253L MT6252 MT6252H MT6250 MT6260
...
TP_INTERNAL_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6268A MT6516 MT6252 MT6252H MT6253 MT6253E MT6253L MT6253T MT6270A MT6276 MT6256 MT6251 MT6573 MT6921 MT6255 MT6922 MT6250 MT6260
ifdef TOUCH_PANEL_SUPPORT
...
ENHANCED_SINGLE_BANK_NOR_FLASH_SUPPORT_SUPPORTED_PLATFORM = MT6205B MT6223 MT6223P MT6225 MT6253T MT6253 MT6253E MT6253L MT6252 MT6252H MT6226 MT6226D MT6226M MT6227 MT6229 MT6230 MT6227D MT6235 MT6235B MT6253 MT6251 MT6253E MT6253L MT6236 MT6921 MT6255 MT6922 MT6250 MT6260
...
ifdef EDGE_SUPPORT
  ifeq ($(strip $(EDGE_SUPPORT)),TRUE)
    EDGE_SUPPORT_PLATFORM = MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268 TK6516 MT6516 MT6268T MT6268H MT6268A MT6268 MT6270A MT6256 MT6276 MT6573 MT6921 MT6255 MT6922 MT6250 MT6260
...
ifdef MP4_DECODE_MODE
  ifeq ($(strip $(MP4_DECODE)),TRUE)
    ifeq ($(strip $(MP4_DECODE_MODE)),SLIM)
      MP4_DECODE_MODE_SLIM_SUPPORT_PLATFORM = MT6253T MT6253 MT6253E MT6253L MT6252 MT6252H MT6276 MT6255 MT6922 MT6256 MT6250 MT6260
...
ifdef MP4_ENCODE_MODE
  ifeq ($(strip $(MP4_ENCODE)),TRUE)
    ifeq ($(strip $(MP4_ENCODE_MODE)),SLIM)
      MP4_ENCODE_MODE_SLIM_SUPPORT_PLATFORM = MT6276
...
ifdef H264_DECODE_MODE
  ifeq ($(strip $(H264_DECODE)),TRUE)
    ifeq ($(strip $(H264_DECODE_MODE)),SLIM)
      H264_DECODE_MODE_SLIM_SUPPORT_PLATFORM = MT6253T MT6253 MT6253E MT6253L MT6252 MT6252H MT6276 MT6235 MT6235B MT6256 MT6250 MT6260
...
CENTRALIZED_SLEEP_MANAGER_PLATFORM = MT6276 MT6573 MT6250 MT6260
...
ifeq ($(strip $(HIGH_DYNAMIC_RANGE_SUPPORT)),TRUE)
  HIGH_DYNAMIC_RANGE_NOSUPPORT_PLATFORM =  MT6268 MT6235 MT6253 MT6253D MT6253T MT6252 MT6252H MT6253PMU MT6250 MT6260
...
ifeq ($(strip $(CAMCORDER_AUTO_SCENE_DETECT_SUPPORT)),TRUE)
  ASD_NOSUPPORT_PLATFORM = MT6253 MT6253T MT6253E MT6253L MT6253PMU MT6252 MT6252H MT6268 MT6235 MT6250 MT6260
...
ifeq ($(strip $(CAMCORDER_ZERO_SHUTTER_DELAY_SUPPORT)),TRUE)
  ZSD_NOSUPPORT_PLATFORM =  MT6253 MT6253T MT6253E MT6253L MT6253PMU MT6252 MT6252H MT6235 MT6268 MT6236 MT6250 MT6260
...
ifeq ($(strip $(MP4_DECODE)),TRUE)
  ifeq ($(strip $(MP4_DECODE_PROFILE)),ASP)
    MP4_DECODE_PROFILE_SUPPORT_PLATFORM = MT6235 MT6236 MT6256 MT6276 MT6235B MT6255 MT6272 MT6922 MT6250 MT6260
...
BES_LIVE_SUPPORT_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 MT6270A MT6256 MT6276 MT6921 MT6252 MT6253 MT6255 MT6922 MT6250 MT6260
...
ifdef VOICE_CHANGER_SUPPORT
  ifneq ($(strip $(VOICE_CHANGER_SUPPORT)),FALSE)
    VOICE_CHANGER_SUPPORT_PLATFORM = MT6260
...
BES_SURROUND_SUPPORT_SUPPORT_PLATFORM = MT6228 MT6229 MT6230 MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H MT6268 MT6268A MT6268 MT6270A MT6256 MT6276 MT6921 MT6252 MT6253 MT6255 MT6922 MT6250 MT6260
...
ifdef BES_LOUDNESS_SUPPORT
  BES_LOUDNESS_SUPPORT_SUPPORT_PLATFORM = MT6225 MT6228 MT6229 MT6230 MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268A MT6268 MT6268T MT6268H MT6268 MT6252 MT6252H MT6253T MT6253 MT6253E MT6253L MT6270A MT6256 MT6276 MT6921 MT6255 MT6922 MT6250 MT6260
...
ifeq ($(strip $(BES_BASS_SUPPORT)),TRUE)
  BES_BASS_SUPPORT_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H MT6268 MT6268A MT6268 MT6270A MT6276 MT6921 MT6255 MT6256 MT6922 MT6250 MT6260
...
ifdef I2S_INPUT_MODE_SUPPORT
  ifeq ($(strip $(I2S_INPUT_MODE_SUPPORT)),TRUE)
    ...
    I2S_INPUT_SUPPORT_PLATFORM = MT6225 MT6253T MT6253 MT6253E MT6253L MT6252 MT6252H MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 MT6256 MT6276 MT6251 MT6921 MT6255 MT6922 MT6250 MT6260
...
BLISRC_SUPPORT_PLATFORM = MT6276 MT6256 MT6255 MT6250 MT6922 MT6260
...
ifdef COOK_DECODE
  ifeq ($(strip $(COOK_DECODE)),TRUE)
    ...
    COOK_DECODE_DSP_PLATFORM = MT6253T MT6253 MT6253E MT6253L MT6252 MT6252H MT6236 MT6236B MT6921 MT6250 MT6260
...
ifdef DRA_DECODE
  ifeq ($(strip $(DRA_DECODE)),TRUE)
    DRA_DECODE_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268T MT6268H MT6268A MT6268 MT6270A MT6276 MT6921 MT6256 MT6255 MT6922 MT6250 MT6260
...
ifeq ($(strip $(AAC_DECODE)),TRUE)
  AAC_DECODE_SUPPORT_PLATFORM = MT6219 MT6226M MT6228 MT6229 MT6230 MT6226 MT6227 MT6225 MT6252 MT6252H MT6253T MT6253 MT6253E MT6253L MT6227D MT6226D MT6238 MT6239 MT6235 MT6235B MT6236 MT6236B MT6268T MT6268H MT6268A MT6268 MT6270A MT6256 MT6276 MT6251 MT6921 MT6255 MT6922 MT6250 MT6260
...
VP8_DECODE_SUPPORT_PLATFORM = MT6250 MT6255 MT6256 MT6276 MT6260
...
ifdef DSP_COMPRESS
  ifneq ($(strip $(DSP_COMPRESS)),NONE)
    DSP_COMPRESS_SUPPORT_PLATFORM = MT6225 MT6253 MT6253D MT6253E MT6253L MT6252 MT6252H MT6250 MT6260
...
ifdef BLUETOOTH_SUPPORT
  ifneq ($(filter BTMTK_MT6250 BTMTK_MT6260, $(strip $(BLUETOOTH_SUPPORT))),)
...
ifeq ($(strip $(FLAC_DECODE)),TRUE)
  FLAC_DECODE_SUPPORT_PLATFORM = MT6255 MT6256 MT6250 MT6260
...
ifneq ($(filter MT6276 MT6255 MT6250 MT6256 MT6260,$(PLATFORM)),)
...
AUDIO_DC_CALIBRATION_PLATFORM = MT6251 MT6255 MT6256 MT6250 MT6922 MT6260
    ...
    ifdef MJPG_ENCODE_MODE
      ifeq ($(strip $(MJPG_ENCODE)),TRUE)
        ...
        ifeq ($(strip $(MJPG_ENCODE_MODE)),SLIM)
          MJPG_ENCODE_MODE_SLIM_SUPPORT_PLATFORM = MT6250 MT6260
...
ifeq ($(strip $(DUAL_SERIAL_FLASH_SUPPORT)),TRUE)
  ...
  ifneq ($(strip $(COMBO_MEMORY_SUPPORT)),TRUE)
    $(warning ERROR: DUAL_SERIAL_FLASH_SUPPORT = TRUE only available when COMBO_MEMORY_SUPPORT = TRUE on MT6250/MT6260.)
    DEPENDENCY_CONFLICT = TRUE
  endif
  ifeq ($(filter MT6250 MT6260,$(PLATFORM)),)
    $(warning ERROR: DUAL_SERIAL_FLASH_SUPPORT = TRUE only available when COMBO_MEMORY_SUPPORT = TRUE on MT6250/MT6260.)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
...
ifdef CLASSK_CHARGEPUMP_SUPPORT
  ifeq ($(strip $(CLASSK_CHARGEPUMP_SUPPORT)),TRUE)
    CLASSK_CHARGEPUMP_SUPPORT_PLATFORM = MT6260
