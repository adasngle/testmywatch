...
SRC_LIST += plutommi\mtkapp\BTdialer\BTdialerSrc\BTdialerApp.c
endif

ifneq ($(filter __BT_SPEAKER_SUPPORT__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\mtkapp\BTSpeaker\BTSpeakerSrc\BTSpeaker.c
endif
...
INC_DIR = applib\inet\engine\include \
          ...
          plutommi\mtkapp\BTdialer\BTdialerInc \
          hal\system\dcmgr\inc \
	  plutommi\mtkapp\BTSpeaker\BTSpeakerInc \
