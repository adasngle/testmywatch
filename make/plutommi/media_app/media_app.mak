...
ifneq ($(filter __MMI_AUDIO_PLAYER__, $(strip $(MODULE_DEFS))),)
	...
	ifneq ($(filter __MMI_AUDIO_PLAYER_BT__, $(strip $(MODULE_DEFS))),)
		SRC_LIST += plutommi\mtkapp\audioplayer\audioplayersrc\AudioPlayerBTNowPlaying.c
	endif
...
ifneq ($(filter __MMI_BT_MUSIC__, $(strip $(MODULE_DEFS))),)
	SRC_LIST += plutommi\mtkapp\BTMusic\BTMusicsrc\BTMusicmain.c
		SRC_LIST += plutommi\mtkapp\audioplayer\audioplayersrc\AudioPlayerBTNowPlaying.c
	endif
...
INC_DIR = applib\inet\engine\include \
          ...
          plutommi\mtkapp\BTMusic\BTMusicinc \
