...
ifdef GUOBI_WINGUO_SUPPORT
  ifneq ($(strip $(GUOBI_WINGUO_SUPPORT)),WINGUO_NONE)
    CUS_REL_BASE_COMP += vendor\search_engine\GUOBI\winguo\project\full \
                         vendor\search_engine\GUOBI\winguo\project\slim
  endif
endif
