...
include make\REL_COMP_COMMON.mak
CUS_REL_FILES_LIST += make\REL_COMP_COMMON.mak
...
REL_MTK_COMP_CR_COMMON += btnotification_conn
...
REL_MTK_COMP_CR_COMMON += gdi_g2d
...
REL_MTK_COMP_CR_COMMON += push_engine
...
REL_MTK_COMP_CR_COMMON += sns
REL_MTK_COMP_CR_COMMON += sso
REL_MTK_COMP_CR_COMMON += supc
REL_MTK_COMP_CR_COMMON += sys_int
REL_MTK_COMP_CR_COMMON += syncml
REL_MTK_COMP_CR_COMMON += voip
REL_MTK_COMP_CR_COMMON += xyssl
...
ifdef SOCIAL_NETWORK_SUPPORT
  ifeq ($(strip $(SOCIAL_NETWORK_SUPPORT)),APP_SOURCE)
    REL_SRC_COMP_CR_COMMON += snsapp
  else ifeq ($(strip $(SOCIAL_NETWORK_SUPPORT)),LIB)
    REL_MTK_COMP_CR_COMMON += snsapp
  endif
endif
