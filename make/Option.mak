...
ifdef XYSSL_SUPPORT
  ifeq ($(strip $(XYSSL_SUPPORT)),TRUE)
    ...
    ifeq ($(filter $(strip $(BROWSER_SUPPORT)) ,$(BROWSER_SUPPORT_Q03C_TYPES)),)
      $(call DEP_ERR_SETA_OR_OFFB,BROWSER_SUPPORT,OBIGO_Q03C,XYSSL_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    endif
...
BLUETOOTH_SUPPORT_CHIP = BTMTK_MT6601 BTMTK_MT6611 BTMTK_MT6612 BTMTK_MT6236 BTMTK_MT6256 BTMTK_MT6276 BTMTK_MT6616 BTMTK_MT6622 BTMTK_MT6626 BTMTK_MT6612_22_26 BTMTK_MT6921 BTMTK_MT6612_22 BTMTK_MT6612_26 BTMTK_MT6622_26 BTMTK_MT6255 BTMTK_MT6922 BTMTK_MT6250 BTMTK_MT6260
# NONE, BTMTK, BTMTK_MT6601, BTMTK_MT6611, BTMTK_MT6612, BTMTK_MT6236, BTMTK_MT6256, BTMTK_MT6276, BTMTK_MT6616 BTMTK_MT6612_22_26 BTMTK_MT6921 BTMTK_MT6255 BTMTK_MT6922 BTMTK_MT6250 BTMTK_MT6260
  ...
  ifneq ($(strip $(BLUETOOTH_SUPPORT)),NONE)
    ...
    ifeq ($(filter $(strip $(BLUETOOTH_SUPPORT)),$(BLUETOOTH_SUPPORT_CHIP)),)
      ifneq ($(strip $(BT_SPP_SERVER)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6256/BTMTK_MT6276/BTMTK_MT6616/BTMTK_MT6622/BTMTK_MT6626/BTMTK_MT6612_22_26/BTMTK_MT6921/BTMTK_MT6255/BTMTK_MT6922/BTMTK_MT6250/BTMTK_MT6260,BT_SPP_SERVER)
        DEPENDENCY_CONFLICT = TRUE
      endif
      ifneq ($(strip $(BT_SPP_CLIENT)),NONE)
        $(call DEP_ERR_SETA_OR_OFFB,BLUETOOTH_SUPPORT,BTMTK_MT6601/BTMTK_MT6611/BTMTK_MT6612/BTMTK_MT6236/BTMTK_MT6256/BTMTK_MT6276/BTMTK_MT6616/BTMTK_MT6622/BTMTK_MT6626/BTMTK_MT6612_22_26/BTMTK_MT6921/BTMTK_MT6255/BTMTK_MT6922/BTMTK_MT6250/BTMTK_MT6260,BT_SPP_CLIENT)
        DEPENDENCY_CONFLICT = TRUE
      endif
    endif
...
ifdef BT_DIALER_SUPPORT
  ifeq ($(strip $(BT_DIALER_SUPPORT)),TRUE)
    ...
    ifneq ($(filter btnotification_conn,$(strip $(REL_MTK_COMP)) $(strip $(REL_SRC_COMP))),)
      COMPLIST  += btnotification_conn
      ifeq ($(strip $(CUSTOM_RELEASE)),FALSE)
        ifeq ($(wildcard make\btnotification_conn\btnotification_conn.mak),)
          $(warning ERROR: This project may need to be upgraded BT Dialer v2.0 (owner: Wen Wu), please contact with CPM to check whether customer want to upgrade or not.)
          DEPENDENCY_CONFLICT = TRUE
        endif
      endif
    endif
...
HORIZONTAL_CAMERA_SUPPORT_SIZE = 128X128 128X160 320X240 176X220 240X320 240X400 320X480 360X640 480X800
...
ifdef BROWSER_SUPPORT
  ...
  ifeq ($(strip $(BROWSER_SUPPORT)),OBIGO_Q03C_SLIM)
    COM_DEFS    +=   OBIGO_Q03C OBIGO_Q03C_SLIM
    COM_DEFS    +=   OBIGO_Q03C_BROWSER
  endif  
  ifeq ($(strip $(BROWSER_SUPPORT)),OBIGO_Q05A)
    COM_DEFS    +=  OBIGO_Q05A
...
SV5_PLATFORM = MT6276 MT6256 MT6251 MT6573 MT6255 MT6922 MT6250 MT6260
...
MEDIA_PLAYER_VER_MAIN_LCD_SIZE = 240X240 128X160 176X220 240X320 240X400 320X480 320X240 360X640 480X800 
...
ifeq ($(strip $(WIFI_BT_SINGLE_ANTENNA_SUPPORT)),TRUE)
  ifeq ($(strip $(WIFI_SUPPORT)),MT5921)
    BT_SINGLE_ANTENNA_SUPPORT_CHIP = BTMTK_MT6612 BTMTK_MT6616 BTMTK_MT6236 BTMTK_MT6276 BTMTK_MT6256 BTMTK_MT6255 BTMTK_MT6921 BTMTK_MT6922 BTMTK_MT6250 BTMTK_MT6260
...
ifneq ($(strip $(YUVCAM_INTERPOLATION)),NONE)
  YUVCAM_INTERPOLATION_SUPPORT_PLATFORM = MT6235 MT6235B MT6253 MT6253E MT6253L MT6252 MT6252H MT6250 MT6260
...
ifneq ($(filter MT6236% MT6252% MT6921 MT6256 MT6255 MT6922 MT6250 MT6260,$(PLATFORM)),)
...
SYNC_LCM_HW_SUPPORT_PLATFORM = MT6235 MT6235B MT6236 MT6236B MT6238 MT6239 MT6268 MT6253T MT6253 MT6516 MT6270A MT6256 MT6276 MT6253E MT6253L MT6252 MT6252H MT6921 MT6255 MT6922 MT6250 MT6260
...
ifdef VIBRATION_SPEAKER_SUPPORT 
  VIBRATION_SPEAKER_SUPPORT_PLATFORM = MT6252 MT6250 MT6260
...
MDP_MULTIPLE_DISPLAY_BUFFER_PLATFORM = MT6253 MT6253T MT6253E MT6253L MT6253PMU MT6252 MT6252H MT6235 MT6268 MT6236 MT6276 MT6256 MT6255 MT6250 MT6922 MT6260
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6255 MT6250 MT6260
...
ifdef BES_EQ_SUPPORT
  ifeq ($(strip $(BES_EQ_SUPPORT)),TRUE)
    EQ_FLEX_SUPPORT_PLATFORM = MT6268 MT6236 MT6276 MT6255 MT6256 MT6250 MT6260
...
ALICE_SUPPORT_PLATFORM = MT6250 MT6260
...
ifeq ($(strip $(DCM_COMPRESSION_SUPPORT)),TRUE)
  ...
  ifeq ($(strip $(DCM_COMPRESSION_DEP_CHECK_OK)),FALSE)
    ...
    $(warning ERROR:  9. PLEASE set DAF_DECODE to TRUE and set DCM_COMPRESSION_AUDIO_CODEC to TRUE and set PLATFORM to MT6250/MT6260 or)
    $(warning ERROR: 10. PLEASE set MELODY_VER to DSP_WT_SYN and set DCM_COMPRESSION_AUDIO_CODEC to TRUE and set PLATFORM to MT6250/MT6260)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
endif
...
ifeq ($(strip $(TIME_LAPSE_VIDEO_RECORDER)),ENABLE)
  ifeq ($(filter $(strip $(PLATFORM)), MT6250 MT6255 MT6260),)
    $(warning ERROR: please disable TIME_LAPSE_VIDEO_RECORDER when PLATFORM is not MT6250 or MT6255 or MT6260)
    DEPENDENCY_CONFLICT = TRUE
  else
    ifeq ($(strip $(MMI_FEATURES_SWITCH)),FALSE)
...
GAS_SUPPORT_SUPPORT = MT6250 MT6260
...
DCM_MM_IMEHW_SUPPORT_PLATFORM = MT6250 MT6260
...
ifdef KINGMOVIE_FILE_FORMAT_SUPPORT
  ifeq ($(strip $(KINGMOVIE_FILE_FORMAT_SUPPORT)),TRUE)
    KINGMOVIE_SUPPORT_PLATFORM = MT6260
...
ifdef DCM_MULTITRUNK
  ifneq ($(strip $(DCM_MULTITRUNK)),NONE)
    DCM_COMPRESSION_PARTIAL_LOADING_SUPPORT_PLATFORM = MT6260 
