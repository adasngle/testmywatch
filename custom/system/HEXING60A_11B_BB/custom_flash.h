...
#define DISK0_REGION_INFO_LAYOUT    {0x10000, 48},

#define DISK1_REGION_INFO_LAYOUT    {0x10000, 48},
#endif

#define ENTIRE_DISK_REGION_INFO_LAYOUT    {0x10000, 512},
...
#define NOR_FLASH_SIZE 0x02000000

const kal_char FLASH_ID[] = "{0xEF, 0x40, 0x19}";
 ...
 * NOR_FLASH_DENSITY: 0x02000000
 * NOR_FLASH_SIZE(Mb): 256
