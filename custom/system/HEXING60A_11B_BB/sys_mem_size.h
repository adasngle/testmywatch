 ...
 */
    #define GLOBAL_MEM_SIZE  (302240 + 22748 - 140944 - 0)
    #define TOTAL_TASK_STACK_SIZE  140944 + 0
    #define GLOBAL_DEBUG_MEM_SIZE  1244
    #define STACK_POOL_COEFFECIENT (100 - 30)
    #define STACK_POOL_SIZE        (140944 * (100 - 30)/100 + 0)
#endif  
