...
BACKLIGHT_POWER_SOURCE = INTERNAL_BL_DRIVER_SOURCE
  # Description:
  #   To specify what kind of backlight source we use
  # Option Values:
  #   INTERNAL_BL_DRIVER_SOURCE: Use internal backlight driver (PMU/PMIC)
  #   EXTERNAL_BL_DRIVER_SOURCE: Use external backlight driver
  # Switch-ability:
  #   INTERNAL_BL_DRIVER_SOURCE -> EXTERNAL_BL_DRIVER_SOURCE
...
MOTION_SENSOR_SUPPORT = MXC6202_I2C
  # Description:
...
DCM_COMPRESSION_MMI_SUPPORT = NONE
  ...
  # Option Values:
  #   DCM_AP_ONLY: Enable mmi ap to use DCMï¼Œshould Only set in 32+32/16+32 segment
  #   NONE: Disable this featureï¼Œin other segment above 32+32 should set NONE  
  # Switch-ability:
  #   N/A
...
CMMB_CAS_2GPP_VER = NONE
  ...
  # Option Values:
  #   NONE: Disable this feature
  #   V10: Support 2G CMMB Post paid version 1.0 (Support å¼€???ˆæ?,need 2G CMMB Chip Support,Such as IF206)
  # Switch-ability:
  #   Non-switchable
...
TIME_LAPSE_VIDEO_RECORDER = ENABLE
  # Description:
...
HORIZONTAL_CAMERA = FALSE #qys TRUE
  # Description:
...
JPG_DECODE_PROGRESSIVE_CAPABILITY = PROGRESSIVE_1M
  # Description:
...
SWITCHABLE_FEATURE = 	FLAVOR  #GEMINI # FALSE, 2, 3, 4 #J2ME_SUPPORT #NEMO, NONE
  # Description:
...
VIBRATION_SPEAKER_SUPPORT = TRUE
  # Description:
...
BROWSER_SUPPORT = NONE  #NONE qys modify
  # Description:
...
COM_DEFS_FOR_HEXING60A_11B_LCM = COLOR_LCD HEXING60A_11B_LCM TFT_MAINLCD     
# *************************************************************************
# Include MODEM.mak
# *************************************************************************
...
CUSTOM_OPTION     +=  __TST_USE_MINI_LOG_BUF__ __IP_NUMBER__
CUSTOM_OPTION     +=  __MONITOR_PAGE_DURING_TRANSFER__ __SMART_PAGING__
CUSTOM_OPTION     +=  __MRE_CUST_MEM_SIZE__=800
CUSTOM_OPTION     +=  __MRE_BGMEM_SIZE__=800
CUSTOM_OPTION     +=  __CUSTOM_MRE_MAX_SIZE__=24
CUSTOM_OPTION     +=  __CAMCO_QUICK_VIEW_ROTATE_SHRAE_APP_MEM__
CUSTOM_OPTION     +=  __MSDC_4BIT_BUSWIDTH__
# *************************************************************************
...
EXISTED_CUS_REL_TRACE_DEFS += gps\mnl\include\mnl_trc.h 
