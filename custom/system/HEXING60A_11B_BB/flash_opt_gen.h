...
*/
    ...
    #define NOR_FLASH_BASE_ADDRESS_DEFAULT     (0x01E00000)
    #define NOR_ALLOCATED_FAT_SPACE_DEFAULT    (0x00200000)
...
#ifdef __FOTA_DM__
    #error "make\HEXING60A_11B_GPRS_gprs.mak: Error! FOTA_ENABLE should not be defined!"
#endif /* __FOTA_DM__ */
