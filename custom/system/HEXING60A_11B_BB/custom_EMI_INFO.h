...
#endif /* __SV5_ENABLED__ */
{
   ...
   "EMI_INF",
    ...
    EMI_DSRAM_VAL_MCP0,
      ...
      EMI_PSRAM_BURST_OP_1_MCP0,
      EMI_PSRAM_BURST_OP_2_MCP0,
      EMI_PSRAM_BURST_OP_3_MCP0,
      EMI_PSRAM_BURST_OP_4_MCP0,
      EMI_PSRAM_BURST_OP_5_MCP0,
      EMI_PSRAM_BURST_OP_6_MCP0,
      EMI_PSRAM_BURST_OP_7_MCP0,
      EMI_PSRAM_BURST_OP_8_MCP0,
   
      EMI_PSRAM_BURST_ADDRESS_1_MCP0,
      EMI_PSRAM_BURST_ADDRESS_2_MCP0,
      EMI_PSRAM_BURST_ADDRESS_3_MCP0,
      EMI_PSRAM_BURST_ADDRESS_4_MCP0,
      EMI_PSRAM_BURST_ADDRESS_5_MCP0,
      EMI_PSRAM_BURST_ADDRESS_6_MCP0,
      EMI_PSRAM_BURST_ADDRESS_7_MCP0,
      EMI_PSRAM_BURST_ADDRESS_8_MCP0,
   
      EMI_PSRAM_BURST_DATA_1_MCP0,
      EMI_PSRAM_BURST_DATA_2_MCP0,
      EMI_PSRAM_BURST_DATA_3_MCP0,
      EMI_PSRAM_BURST_DATA_4_MCP0,
      EMI_PSRAM_BURST_DATA_5_MCP0,
      EMI_PSRAM_BURST_DATA_6_MCP0,
      EMI_PSRAM_BURST_DATA_7_MCP0,
      EMI_PSRAM_BURST_DATA_8_MCP0,
