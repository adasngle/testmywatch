 ...
 * Author:
 * -------
 *   Carlos Yeh (mtk02377)     system auto generatorv6.80 -> p6.81 -> p6.84 -> p6.85 -> p6.86 -> p6.88 -> p6.89 -> p6.90 -> p6.87 -> p6.91 + scatFrame v0.08 -> p0.09 + sysGenUtility v0.40
 *
 *============================================================================
 *             HISTORY
...
#define FOTA_UE_EXECUTION_BASE     (0x00780000)
...
#define FOTA_MAUI_IMAGE_AMOUNT     (1)
      ...
      #define MAX_LENGTH_DSP_ROM  (0x100000)
            ...
            #define MAX_LENGTH_ROM  (MAX_ROM_SIZE)
         #else  /* MAX_ROM_SIZE */
            #define MAX_LENGTH_ROM  (0x01C30000)
         #endif  /* MAX_ROM_SIZE */
      #else
         #define MAX_LENGTH_ROM     (0xFFFFFFFF)
      #endif
...
#define FOTA_PACKAGE_STORAGE_BASE  (0x11D00000)

#define FOTA_PACKAGE_STORAGE_SIZE  (0x00000000)

#define FOTA_PACKAGE_BLOCK_NUMBER  (4)

#define FOTA_BACKUP_STORAGE_BASE   (0x11D00000)
