...
const kal_uint8 EINT_LABELID_MAX = 6;
...
{GPIO_VALID, 34, eintname[2], NULL},
{GPIO_VALID, 35, eintname[3], NULL},
{GPIO_VALID, 11, eintname[4], NULL},
{GPIO_VALID, 20, eintname[5], NULL},
};
