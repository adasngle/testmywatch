...
#define NVRAM_EF_HEART_RATE_SIZE    sizeof(srv_heart_rate_struct)
#define NVRAM_EF_HEART_RATE_TOTAL   (3)
#endif
//qys add
#ifdef __MMI_MAINLCD_240X240__
typedef struct
{
    ...
    MYTIME time;
    kal_uint8 average_heart_rate;//HR=heart rate
    kal_uint8 smooth_heart_rate;
    float heart_rate_speed_ratio;
    kal_uint8 health_lelve[10];
    kal_uint8 relax_lelve;
    kal_uint8 ratio_of_breathe;	
    kal_uint8 heart_risk;
    kal_uint8 heart_age;

} srv_heart_rate_struct;
