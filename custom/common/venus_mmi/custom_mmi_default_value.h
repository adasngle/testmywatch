...
#if !defined(__MMI_MAINLCD_240X320__) && defined(__MMI_WORLDCLOCK_SLIM__)
#if defined(__MMI_MAINLCD_480X800__)
#define WC_FRN_CITY_NUM 5
#else
#define WC_FRN_CITY_NUM 4
#endif
#else
#define WC_FRN_CITY_NUM             3
#endif
#else
#define WC_FRN_CITY_NUM             2
#endif
...
#define MMI_ALM_MAX_LABEL_LENGTH ((20 + 1) * ENCODING_LENGTH)
...
typedef struct
{
    ...
    kal_uint8 State;
    kal_uint8 Freq;
    kal_uint8 Snooze;   /* number of snooze time */
    unsigned char Days;
	...
	kal_uint8 label[MMI_ALM_MAX_LABEL_LENGTH];
...
#ifdef __GEMINI__
#if (GEMINI_PLUS >= 3)
#define  NVRAM_NITZ_NW_NAME_TOTAL GEMINI_PLUS
#else
...
/* } */
#define MAX_SYNCML_DATABASE_NUM 4
#define MAX_SYNCML_SV_PROFILES         5
...
#define MAX_SYNCML_DEV_NUM		  5    /* Device sync */
