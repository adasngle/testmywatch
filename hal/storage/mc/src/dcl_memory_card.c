...
#if defined(__MSDC_SD_MMC__) && defined(MSDC_CACHED_SUPPORT) && !((defined(__UBL__) || defined(__FUE__)) && defined(__EMMC_BOOTING__))
...
#if defined(__MSDC_SD_MMC__) && defined(MSDC_CACHED_SUPPORT)
