...
#define SD_IS_CMD_BUSY   	(MSDC_Reg32(SDC_STA) & SDC_STA_FECMDBUSY)
#else
#define SD_IS_CMD_BUSY   	(MSDC_Reg32(SDC_STA) & SDC_STA_CMDBUSY)
#endif
#ifdef MSDC_DEFECT_WRITE_CRCERR	// WHQA_0006199 workaround for MT6236E2 write crc not reported (solution 2)
#define SD_IS_DAT_BUSY   	(MSDC_Reg32(SDC_STA) & SDC_STA_FEDATBUSY)
#else
#define SD_IS_DAT_BUSY   	(MSDC_Reg32(SDC_STA) & SDC_STA_DATBUSY)
#endif
#ifdef MSDC_DEFECT_WRITE_CRCERR	// WHQA_0006199 workaround for MT6236E2 write crc not reported (solution 2)
#define SD_IS_SDC_BUSY   	(MSDC_Reg32(SDC_STA) & (SDC_STA_FECMDBUSY|SDC_STA_FEDATBUSY))
#else
...
#define SD_IS_BLKDONE_2		(MSDC_Reg32(SDC_DATSTA2) & SDC_DATSTA_BLKDONE)
#define SD_IS_DATA_CRCERR_2	(MSDC_Reg32(SDC_DATSTA2) & SDC_DATSTA_DATCRCERR)
#define SD_IS_DATA_TIMEOUT_2	(MSDC_Reg32(SDC_DATSTA2) & SDC_DATSTA_DATTO)
#define SD_IS_RSP_CRCERR_2		(MSDC_Reg32(SDC_CMDSTA2) & SDC_CMDSTA_CMDCRCERR)
#define SD_IS_CMD_TIMEOUT_2	(MSDC_Reg32(SDC_CMDSTA2) & SDC_CMDSTA_CMDTO)
#define SD_IS_CMD_READY_2		(MSDC_Reg32(SDC_CMDSTA2) & SDC_CMDSTA_CMDRDY)
#define SD_IS_MMC_IRQ_2		(MSDC_Reg32(SDC_CMDSTA2) & SDC_CMDSTA_MMCIRQ)
#define SD_IS_CMD_BUSY_2		(MSDC_Reg32(SDC_STA2) & SDC_STA_CMDBUSY)
#define SD_IS_DAT_BUSY_2		(MSDC_Reg32(SDC_STA2) & SDC_STA_DATBUSY)
#define SD_IS_SDC_BUSY_2		(MSDC_Reg32(SDC_STA2) & SDC_STA_SDCBUSY)
#define SD_IS_R1B_BUSY_2		(MSDC_Reg32(SDC_STA2) & SDC_STA_R1BSY)
#endif
