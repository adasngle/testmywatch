...
typedef struct
{
    kal_uint8     Reserved1[4];     // reserved area (non-ECC protected)
    kal_uint16    BI;               // byte 4, 5
    kal_uint16    BM_PA;            // byte 6, 7
    kal_uint16    LBA;              // byte 8, 9
    kal_uint16    PBA;              // byte A, B
    kal_uint8     ECC_0[4];
...
typedef struct
{
    kal_uint8     Reserved1[8];     // reserved area (non-ECC protected)
    kal_uint16    BI;               // byte 8, 9
    kal_uint16    BM_PA;            // byte A, B
    kal_uint16    LBA;              // byte C, D
    kal_uint16    PBA;              // byte E, F
    kal_uint8     Unused[16 * 3];
} FDMDataU_2K_MTK_2;
