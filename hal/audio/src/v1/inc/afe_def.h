...
//=============================================================================================
   #define __AFE_AudVoice_SingleClkSrc__ ( defined(MT6255) || defined(MT6250) || defined(MT6260))
   ...
   #define __AFE_2ndG_AC_COUPLE__ ( defined(MT6250) || defined(MT6260))
   #define __AFE_VOICE_AMP_AS_LOUDSPK__ ( defined(MT6250) || defined(MT6260) ) 
   #define __AFE_KARAOK_SUPPORT__ ( defined(MT6255) || defined(MT6250) || defined(MT6260))
   #define __AFE_I2S_FOC_SUPPORT__ ( defined(MT6251) || defined(MT6256) )
   //FOC (I2S slave mode freq. compensation)
   #define __AFE_OC_DETECTION__ ( defined(MT6255) || defined(MT6256) || defined(MT6252) || defined(MT6252H) || defined(MT6236) \
                                  || defined(MT6236B) || defined(MT6250) || defined(MT6260))
   //Over current detect
   ...
   #define __AFE_ANALOG_GAIN_REVERSE_ORDER__  ( defined(MT6255) || defined(MT6251) || defined(MT6256) )
   #define __AFE_SW_DC_COMPENSATION__ ( defined(MT6252H) || defined(MT6252) || defined(MT6236) || defined(MT6236B) )
   #define __AFE_HW_DC_COMPENSATION__ ( defined(MT6251) || defined(MT6256) || defined(MT6255) || defined(MT6250) || defined(MT6260))
   ...
   #define __AFE_ANALOG_GAIN_LOWER_BOUND__   ( defined(MT6255) || defined(MT6251) || defined(MT6256) || defined(MT6250) || defined(MT6260))
   //the bit of AFE_AMCU_CON2[6] support: audio data come from EDI or DSP select 

   #define __AFE_MD2G_PWDN_LOCK__   ( defined(MT6250) || defined(MT6260))
//=============================================================================================
...
//=============================================================================================
   ...
   #define __AFE_AUDIO_DELAY_OFF__ ( defined(MT6252) || defined(MT6252H) || defined(MT6236) || defined(MT6236B) || defined(MT6253) \
                                     || defined(MT6235) || defined(MT6235B) || defined(MT6250) || defined(MT6260))

   #define __AFE_PA_DELAY_OFF__ 0             //currently only 6250/60 support it 
   #define __AFE_HP_DC_CALIBRATION__       (defined(MT6260))  //currently only 6260 support it
#if defined(__VIBRATION_SPEAKER_SUPPORT__) && defined(MT6260) //currently only 6260 support it
...
#endif 
#if defined(__CLASSK_CP_SUPPORT__) && defined(MT6260)  //currently only 6260 support it
   #define __AFE_CLASSK_SUPPORT_INTERNAL__ 1 
   #define THERMAL_EINT 25
#endif    
/*
============================================================================================================
------------------------------------------------------------------------------------------------------------
