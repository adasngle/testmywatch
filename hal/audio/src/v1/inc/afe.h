...
#if defined(MT6251) || defined(MT6256) || defined(MT6255) || defined(MT6250) || defined(MT6260)
   kal_bool       bPowerDown;
#endif
#if __AFE_HW_DC_COMPENSATION__
...
#elif defined(MT6236) || defined(MT6236B) || defined(MT6253) || defined(MT6251) || defined(MT6256) || defined(MT6255) || defined(MT6250) // MT6260/50 no line in path
...
//                  Section: Feature 
//=============================================================================================
#if defined(MT6256) || defined(MT6236) || defined(MT6236B) || defined(MT6255) || defined(MT6250) || defined(MT6260)
...
//=============================================================================================
 ...
 #elif defined(MT6255) || defined(MT6250)  || defined(MT6260)
   #define SPK_OC_FLAG        (0x1 << 14) //SPK_CON0
   #define SPK_OC_AUTOFF      (0x1 << 12) //SPK_CON0
   #define SPK_CLASSAB_OC_EN  (0x1 << 8)  //SPK_CON7
 #endif
