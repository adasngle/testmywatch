...
kal_int32 Vibr_Filter_Stack[2][8]={0};
#endif
...
static kal_uint32 pcmsink_WriteDataToDsp(kal_uint16 *pSrc16, kal_uint32 uSrcWord, kal_bool fMono2Stereo)
{
   ...
   pIdmaPtr = DSP_DM_ADDR(PCM_PLAYBACK_DSP_PAGE_NUM, uDspWritePos);
    ...
    if (AFE_IsAudioLoudSpk())
    {
        ...
        Vibration_Notch_Filter_16Bit(pSrc16, pSrc16, is_stereo, buffer_size_in_bytes, (kal_int32 *)&Vibr_Filter_Stack[0][0], (kal_uint32 *)&VIBR_NVRAM_DATA.VIBR_NVRAM_LOUD_FILTER_COEF[0][smpl_rate_idx][0]);
        Vibration_Notch_Filter_16Bit(pSrc16, pSrc16, is_stereo, buffer_size_in_bytes, (kal_int32 *)&Vibr_Filter_Stack[1][0], (kal_uint32 *)&VIBR_NVRAM_DATA.VIBR_NVRAM_LOUD_FILTER_COEF[1][smpl_rate_idx][0]);
    }
#endif 
