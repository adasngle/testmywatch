...
#if defined(MT6235) || defined(MT6235B) || defined(MT6268) || defined(MT6253) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6251) || defined(MT6253E) || defined(MT6253L)|| defined(MT6252) || defined(MT6252H) || defined(MT6260)
...
#if (defined(__CENTRALIZED_SLEEP_MANAGER__) && (defined(MT6250) || defined(MT6260)))
...
uint8 spe_table[SPH_MODE_UNDEFINED] = {
   ...
   0, 0, 0, 0, 0, 0, 0,
#elif defined(MT6235) || defined(MT6235B) || defined(MT6268) || defined(MT6253) || defined(MT6236) || defined(MT6236B) || defined(MT6256_S00) || defined(MT6256_S01) || defined(MT6255) || defined(MT6250)  || defined(MT6251) || defined(MT6253E) || defined(MT6253L)|| defined(MT6252) || defined(MT6252H) || defined(MT6260)
   #if TDDNC_SUPPORT
      #if defined(AEC_ENABLE)          
	  	#if defined(__DUAL_MIC_SUPPORT__) //in FD216, DMNR's running depends on 
		  /* SPH_MODE_NORMAL */      SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_DMNR_FLAG + SPE_AGC_FLAG,
		#else
	      /* SPH_MODE_NORMAL */      SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
	    #endif
      #else 
      /* SPH_MODE_NORMAL */      SPE_ES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #endif 
      #if defined(AEC_ENABLE)           
      /* SPH_MODE_EARPHONE */    SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #else 
      /* SPH_MODE_EARPHONE */    SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #endif  
      #if defined(EES_ENABLE)
      /* SPH_MODE_LOUDSPK */     SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #else
      /* SPH_MODE_LOUDSPK */     SPE_ES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #endif
      #if defined(AEC_ENABLE) && defined(__BT_SUPPORT__)         
      /* SPH_MODE_BT_EARPHONE */ SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #else 
      /* SPH_MODE_BT_EARPHONE */ SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #endif
#if defined(BT_DIALER_SPE_FOR_LOUDSPEAKER) || defined(BT_DIALER_SPE_FOR_RECEIVER)
      #if defined(EES_ENABLE)
      /* SPH_MODE_BT_CORDLESS */ SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG,
      #else
...
#endif  // BT dialer SPE
      #if defined(EES_ENABLE)
      /* SPH_MODE_BT_CARKIT */   SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #else 
      /* SPH_MODE_BT_CARKIT */   SPE_ES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_AGC_FLAG,
      #endif    
   #else
      #if defined(AEC_ENABLE)     
	  	#if defined(__DUAL_MIC_SUPPORT__)
		  /* SPH_MODE_NORMAL */      SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_DMNR_FLAG + SPE_AGC_FLAG,
		#else
      	  /* SPH_MODE_NORMAL */      SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      	#endif
      #else 
      /* SPH_MODE_NORMAL */      SPE_ES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #endif 
      #if defined(AEC_ENABLE)           
      /* SPH_MODE_EARPHONE */    SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #else 
      /* SPH_MODE_EARPHONE */    SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG + SPE_AGC_FLAG,
      #endif  
      #if defined(EES_ENABLE)
      /* SPH_MODE_LOUDSPK */     SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #else
      /* SPH_MODE_LOUDSPK */     SPE_ES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #endif
      #if defined(AEC_ENABLE) && defined(__BT_SUPPORT__)         
      /* SPH_MODE_BT_EARPHONE */ SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #else 
      /* SPH_MODE_BT_EARPHONE */ SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #endif
#if defined(BT_DIALER_SPE_FOR_LOUDSPEAKER) || defined(BT_DIALER_SPE_FOR_RECEIVER)
      #if defined(EES_ENABLE)
      /* SPH_MODE_BT_CORDLESS */ SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG,
...
#endif  // BT dialer SPE
      #if defined(EES_ENABLE)
      /* SPH_MODE_BT_CARKIT */   SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #else 
      /* SPH_MODE_BT_CARKIT */   SPE_ES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_AGC_FLAG,
      #endif   
   #endif
#endif
   /* SPH_MODE_AUX2 */        0,
...
void SetSpeechEnhancement( bool ec )
{
    ...
    return;
#endif
   //if( (!AM_IsSpeechOn() || !l1sp.spe_flag) && !AM_IsVoIPOn())
...
//#if defined(__CUSTOM_SPE_ENGINE__)
      {
         ...
         //SPE_CustomProcess(KAL_TRUE, l1sp.sph_mode, &spe_par, &next_state);
      }
//#endif
	  // using l1sp.spe_app_mask to control the open/close of speech enhancment. 
...
//#if defined(__CUSTOM_SPE_ENGINE__)
      ...
      //SPE_CustomProcess(KAL_FALSE, l1sp.sph_mode, NULL, NULL);
//#endif
   }
   ...
   if((l1sp.spe_app_mask & (SPH_ENH_MASK_SIDETONE)) != 0) {
      if( (l1sp.sph_mode==SPH_MODE_LOUDSPK)
         ...
         AFE_SetSidetone( false );//When AEC is turned off or the big volume of DL, it will cause sidetone generates howling sounds
      }else{
...
static void setSrcControl(uint8 prev_sph_mode, uint8 current_sph_mode)
{
#if defined(MT6256_S01) || defined(MT6255) || defined(MT6250) || defined(MT6260)
	if( prev_sph_mode != current_sph_mode ){
		if(
      #if defined(__BT_SUPPORT__)
		   AM_IsBTCordlessMode() ||
      #endif
...
{
   bool ret;
#if (defined(__CENTRALIZED_SLEEP_MANAGER__) && defined(MTK_SLEEP_ENABLE) && (defined(MT6250) || defined(MT6260)))
   kal_uint16 aud_id = L1SP_GetAudID();
#endif   
