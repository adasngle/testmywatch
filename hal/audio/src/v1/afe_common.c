...
void AFE_SetOutputGainControl(uint8 aud_func, uint32 total_gain)
{
   ...
   { 
      ...
      if(volume<AGAIN_LOWBOUND_SETTING) //lower bound is 68
      { 
...
void AFE_RegisterBackup(void)
{
   ...
   afe.regbak.VAGC_CON0 = *AFE_VAGC_CON0;
   afe.regbak.DAC_TEST  = *AFE_DAC_TEST;
   afe.regbak.VMCU_CON1 = *AFE_VMCU_CON1;
   afe.regbak.VMCU_CON2 = *AFE_VMCU_CON2;
   afe.regbak.VAGC_CON1 = *AFE_VAGC_CON1;
   afe.regbak.VAGC_CON2 = *AFE_VAGC_CON2;
   afe.regbak.VAGC_CON3 = *AFE_VAGC_CON3;
   afe.regbak.VAGC_CON4 = *AFE_VAGC_CON4;
   afe.regbak.VAGC_CON5 = *AFE_VAGC_CON5;
   afe.regbak.VAGC_CON6 = *AFE_VAGC_CON6;
...
void AFE_RegisterStore(void)
{
   ...
   *AFE_VAGC_CON0 = afe.regbak.VAGC_CON0;
   *AFE_DAC_TEST  = afe.regbak.DAC_TEST;  
   *AFE_VMCU_CON1 = afe.regbak.VMCU_CON1; 
   *AFE_VMCU_CON2 = afe.regbak.VMCU_CON2; 
   *AFE_VAGC_CON1 = afe.regbak.VAGC_CON1; 
   *AFE_VAGC_CON2 = afe.regbak.VAGC_CON2; 
   *AFE_VAGC_CON3 = afe.regbak.VAGC_CON3; 
   *AFE_VAGC_CON4 = afe.regbak.VAGC_CON4; 
   *AFE_VAGC_CON5 = afe.regbak.VAGC_CON5; 
   *AFE_VAGC_CON6 = afe.regbak.VAGC_CON6; 
