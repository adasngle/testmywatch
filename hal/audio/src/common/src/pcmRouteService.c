...
static void PcmRut_PutData( kal_uint16 *pSampleBuf )
{
   ...
   idmaPtr = DSP_DM_ADDR(pcmRut.pageNum, pcmRut.bufAddr);
    ...
    if(AFE_IsAudioLoudSpk())
    {
        ...
        Vibration_Notch_Filter_16Bit(pSampleBuf, pSampleBuf, is_stereo, buffer_size_in_bytes, (kal_int32 *)&Vibr_Filter_Stack[0][0], (kal_uint32 *)&VIBR_NVRAM_DATA.VIBR_NVRAM_LOUD_FILTER_COEF[0][smpl_rate_idx][0]);
        Vibration_Notch_Filter_16Bit(pSampleBuf, pSampleBuf, is_stereo, buffer_size_in_bytes, (kal_int32 *)&Vibr_Filter_Stack[1][0], (kal_uint32 *)&VIBR_NVRAM_DATA.VIBR_NVRAM_LOUD_FILTER_COEF[1][smpl_rate_idx][0]);
    }
#endif 
