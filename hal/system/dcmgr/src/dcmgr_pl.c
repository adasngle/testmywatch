...
extern kal_uint32 Image$$DYNAMIC_COMP_SBC_BODY$$ZI$$Base;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SBC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SBC_BODY$$ZI$$Base,
...
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$ZI$$Base;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_BESLOUDNESS_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$ZI$$Base,
...
extern kal_uint32 Image$$DYNAMIC_COMP_MP4DEC_BODY$$ZI$$Base;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MP4DEC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MP4DEC_BODY$$ZI$$Base,
...
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ENC_BODY$$ZI$$Base;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MP4ENC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MP4ENC_BODY$$ZI$$Base,
...
extern kal_uint32 Image$$DYNAMIC_COMP_H264DEC_BODY$$ZI$$Base;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_H264DEC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_H264DEC_BODY$$ZI$$Base,
...
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MP4ASPDEC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MP4ASPDEC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VP8DEC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VP8DEC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VP8DEC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VP8DEC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VCH_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VCH_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VCH_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VCH_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VCH_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MATVDRIVER_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MATVDRIVER_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MATVDRIVER_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MATVDRIVER_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MATVDRIVER_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VEENC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VEENC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VEENC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VEDEC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VEDEC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VEDEC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_DAF_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_DAF_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_DAF_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_DAF_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_WAVETABLE_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_WAVETABLE_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_WAVETABLE_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_BROWSER_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BROWSER_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_BROWSER_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_BROWSER_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_BROWSER_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CALC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CALC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CALC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CALC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CALC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CALLSET_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CALLSET_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CALLSET_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CALLSET_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CALLSET_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CAMCO_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CAMCO_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CAMCO_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMCO_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMCO_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CLNDR_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CLNDR_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CLNDR_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CLNDR_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CLNDR_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CLOCK_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CLOCK_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CLOCK_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CLOCK_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CLOCK_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_FMRADIO_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_FMRADIO_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_FMRADIO_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_FMRADIO_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_FMRADIO_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SOUNDSET_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SOUNDSET_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SOUNDSET_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SOUNDSET_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SOUNDSET_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_COSMOS_EM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_COSMOS_EM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_COSMOS_EM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_COSMOS_EM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_COSMOS_EM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_COSMOS_FM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_COSMOS_FM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_COSMOS_FM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_COSMOS_FM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_COSMOS_FM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_COSMOS_DTCNT_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_COSMOS_DTCNT_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_COSMOS_DTCNT_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_COSMOS_DTCNT_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_COSMOS_DTCNT_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MOT_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MOT_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MOT_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MOT_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MOT_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SECSET_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SECSET_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SECSET_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SECSET_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SECSET_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_BAIDUSEARCH_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BAIDUSEARCH_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_BAIDUSEARCH_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_BAIDUSEARCH_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_BAIDUSEARCH_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_BOOTUP_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BOOTUP_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_BOOTUP_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_BOOTUP_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_BOOTUP_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SETTING_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SETTING_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SETTING_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SETTING_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SETTING_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SOUNDREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SOUNDREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SOUNDREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SOUNDREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SOUNDREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CAMIMGV_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CAMIMGV_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CAMIMGV_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMIMGV_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMIMGV_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VDOREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VDOREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VDOREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VDOREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VDOREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CALENDAR_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CALENDAR_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CALENDAR_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CALENDAR_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CALENDAR_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CALCULATOR_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CALCULATOR_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CALCULATOR_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CALCULATOR_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CALCULATOR_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VDOPLY_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VDOPLY_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VDOPLY_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VDOPLY_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VDOPLY_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MATV_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MATV_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MATV_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MATV_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MATV_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SNDREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SNDREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SNDREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SNDREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SNDREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_PROFILE_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_PROFILE_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_PROFILE_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_PROFILE_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_PROFILE_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CALLSETTING_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CALLSETTING_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CALLSETTING_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CALLSETTING_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CALLSETTING_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SCRLOCK_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SCRLOCK_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SCRLOCK_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SCRLOCK_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SCRLOCK_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_SETTINGS_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_SETTINGS_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_SETTINGS_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_SETTINGS_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_SETTINGS_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_DTCNT_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_DTCNT_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_DTCNT_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_DTCNT_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_DTCNT_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_EM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_EM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_EM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_EM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_EM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_FM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_FM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_FM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_FM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_FM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_AMRREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_AMRREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_AMRREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_AMRREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_AMRREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_WAVREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_WAVREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_WAVREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_WAVREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_PCMREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_PCMREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_PCMREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_PCMREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_PCMREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MDP_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MDP_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MDP_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MDP_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MDP_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VECOM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VECOM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VECOM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VECOM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VECOM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_RENDER_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_RENDER_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_RENDER_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_RENDER_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_RENDER_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MDICAM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MDICAM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MDICAM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MDICAM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MDICAM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MWREC_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MWREC_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MWREC_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MWREC_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MWREC_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MDIVID_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MDIVID_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MDIVID_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MDIVID_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MDIVID_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VIDMSG_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VIDMSG_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VIDMSG_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VIDMSG_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VIDMSG_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MWWEBCAM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MWWEBCAM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MWWEBCAM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MWWEBCAM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MWWEBCAM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_USBVIDEO_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_USBVIDEO_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_USBVIDEO_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_USBVIDEO_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_USBVIDEO_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MDIMTV_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MDIMTV_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MDIMTV_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MDIMTV_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MDIMTV_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MEDMTV_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MEDMTV_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MEDMTV_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MEDMTV_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MEDMTV_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MDISTREAM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MDISTREAM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MDISTREAM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MDISTREAM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MDISTREAM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_MEDSTREAM_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MEDSTREAM_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_MEDSTREAM_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_MEDSTREAM_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_MEDSTREAM_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CAMCAL_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CAMCAL_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CAMCAL_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMCAL_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMCAL_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_CAMMED_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CAMMED_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_CAMMED_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMMED_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_CAMMED_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_VKLAYOUT_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VKLAYOUT_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_VKLAYOUT_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_VKLAYOUT_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_VKLAYOUT_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_GUOBIHW_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_GUOBIHW_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_GUOBIHW_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_GUOBIHW_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_GUOBIHW_BODY$$ZI$$Length
};
#pragma arm section rodata
...
extern kal_uint32 Image$$DYNAMIC_COMP_IME_BODY$$ZI$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_IME_BODY$$ZI$$Length;
...
const dcmgr_image_header_t   dcmgr_dynamic_comp_IME_head = {
    ...
    (kal_uint32)&Image$$DYNAMIC_COMP_IME_BODY$$ZI$$Base,
    (kal_uint32)&Image$$DYNAMIC_COMP_IME_BODY$$ZI$$Length
};
#pragma arm section rodata
...
static const kal_uint32 *DCM_comp_exec_region_addr[DYNAMIC_CODE_COMPRESS_NUM] = {
#if defined(DCM_COMP_EXEC_REGION_SBC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SBC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_BESLOUDNESS_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_BESLOUDNESS_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MP4DEC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MP4DEC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MP4ENC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MP4ENC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_H264DEC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_H264DEC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MP4ASPDEC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MP4ASPDEC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VP8DEC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VP8DEC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VCH_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VCH_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MATVDRIVER_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MATVDRIVER_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VEENC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VEENC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VEDEC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VEDEC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_DAF_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_DAF_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_WAVETABLE_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_WAVETABLE_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_BROWSER_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_BROWSER_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CALC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CALC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CALLSET_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CALLSET_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CAMCO_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CAMCO_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CLNDR_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CLNDR_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CLOCK_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CLOCK_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_FMRADIO_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_FMRADIO_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SOUNDSET_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SOUNDSET_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_COSMOS_EM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_COSMOS_EM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_COSMOS_FM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_COSMOS_FM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_COSMOS_DTCNT_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_COSMOS_DTCNT_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MOT_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MOT_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SECSET_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SECSET_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_BAIDUSEARCH_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_BAIDUSEARCH_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_BOOTUP_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_BOOTUP_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SETTING_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SETTING_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SOUNDREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SOUNDREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CAMIMGV_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CAMIMGV_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VDOREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VDOREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CALENDAR_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CALENDAR_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CALCULATOR_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CALCULATOR_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VDOPLY_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VDOPLY_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MATV_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MATV_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SNDREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SNDREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_PROFILE_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_PROFILE_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CALLSETTING_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CALLSETTING_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SCRLOCK_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SCRLOCK_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_SETTINGS_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_SETTINGS_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_DTCNT_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_DTCNT_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_EM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_EM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_FM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_FM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_AMRREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_AMRREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_WAVREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_WAVREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_PCMREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_PCMREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MDP_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MDP_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VECOM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VECOM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_RENDER_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_RENDER_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MDICAM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MDICAM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MWREC_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MWREC_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MDIVID_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MDIVID_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VIDMSG_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VIDMSG_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MWWEBCAM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MWWEBCAM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_USBVIDEO_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_USBVIDEO_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MDIMTV_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MDIMTV_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MEDMTV_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MEDMTV_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MDISTREAM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MDISTREAM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_MEDSTREAM_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_MEDSTREAM_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CAMCAL_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CAMCAL_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_CAMMED_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_CAMMED_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_VKLAYOUT_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_VKLAYOUT_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_GUOBIHW_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_GUOBIHW_ADDRESS,
#endif
#if defined(DCM_COMP_EXEC_REGION_IME_ADDRESS)
			(kal_uint32*) DCM_COMP_EXEC_REGION_IME_ADDRESS,
#endif
};

const kal_uint32 DCM_comp_group_by_dynamic_code_id[DYNAMIC_CODE_COMPRESS_NUM] = {
    DCM_COMP_GROUP_CONFIGURE
}; 


const kal_uint32 DCM_comp_pool_by_dynamic_code_id[DYNAMIC_CODE_COMPRESS_NUM] = {
...
kal_uint32 current_comp_group_id[DCM_COMP_TARGET_NUM];
...
static kal_bool DCMGR_Init_Trunk_Information()
{
	  ...
	  if( trunk_buffer_mem_init(dcmgr_trunk_info_buff_pool, DCMGR_TRUNK_INFO_BUFF_SIZE) == 1)
	  {
	      ...
	      for( idx = 0 ; idx < dcmgr_code_ptr->dcmgr_img_num ; idx++ )
	      {
            ...
            exec_addr = (kal_uint32)DCM_comp_exec_region_addr[code_id&DYNAMIC_POOL_ID_MASK];
