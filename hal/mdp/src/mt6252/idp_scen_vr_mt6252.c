 ...
 * ------------
 *    pass 1:
 *    ISP -> CRZ -> ROTDMA  ==> display
 *
 *    pass 2:
 *    ISP -> CRZ -> ROTDMA ==> video encode
 *
 * Author:
 * -------
 * -------
