...
/***** Chip Options *****/
    ...
    #define MSDC_DRV_SUPPORT_LPWR
	#define DRV_MSDC_CHECK_MULTIBLOCK_WRITE_FINISHED
#ifdef DRV_MSDC_SLIM_MT6250D_3232_PLUTO
    #define DRV_MSDC_SLIM_MT6250D_MMC // MT6250D 3232_PLUTO
    #undef  MSDC_MMC441_SUPPORT
    ...
    #undef MSDC_MMC441_SUPPORT
		#undef MSDC_MMC40_SUPPORT
    #define DRV_MSDC_DRIVING_6260_SERIES
    #define DRV_MSDC_SLIM   
...
#if defined(MT6268) || defined(MT6250)
#define DRV_MSDC_4_BYTE_BURST
#endif
...
#if !defined(MT6253L) && !defined(MT6253E) && !defined(MT6252) && !defined(MT6252H) && !defined(MT6251) && !defined(MT6250)&& !defined(MT6260)
