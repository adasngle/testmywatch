...
#elif defined(DRV_TP_6250_SERIES)
     #define DRV_TOUCH_PANEL_PAIR_GUARANTEE
   #define DRV_TOUCH_PANEL_CUSTOMER_PARAMETER
   #define __DRV_TP_MEMORY_TRACE__

#ifdef TOUCH_PANEL_INTERNAL
   /// lxg add just for pressure flow start
#define DRV_AUX_ADC_TP_MESSED_UP_WA
#define DRV_TP_ADC_WARM_UP_ISSUE_WA
#define DRV_TP_STAT_NOT_UP_TO_DATE_WA
   // end
   ...
   #endif
   #define DRV_ADC_TOUCH_SCREEN_OFFSET_0X50
   #define DRV_TS_USE_DEFAULT_SPL_NUM
   #define DRV_TS_USE_SINGLE_END_MODE
   #define DRV_TS_BUS_EARLY_RESPONSE
   #define DRV_TS_SW_RESET_CHECK_FOR_BUSY_BIT
#endif
#define DRV_TP_PENUP_FIXED
#ifdef DRV_AUX_ADC_TP_MESSED_UP_WA
// For the WA, we read ADC in HISR to avoid race condition,
//but 60 is not needed,casue tp task removed
 #define __READ_TP_DATA_IN_HISR__
#define DRV_TS_CHECK_SPL_TO_AVOID_RACE_CONDITON
#endif 
   // lxg add just for pressure flow start
//#define DRV_TP_6253_SETTING
//end
#define DRV_TP_SLIM
   //end
   #define DRV_TP_IRQ_TPC
   #define DRV_TP_SPL_NUM_ABB_0094
   #define DRV_TP_ADIE_DDIE_STRCUTURE //lxg add for 6250 touch panel
#elif defined(DRV_TP_6260_SERIES)
#define DRV_TOUCH_PANEL_PAIR_GUARANTEE
#define DRV_TOUCH_PANEL_CUSTOMER_PARAMETER
#define __DRV_TP_MEMORY_TRACE__
#ifdef TOUCH_PANEL_INTERNAL
...
//end
#define DRV_TP_IRQ_TPC
#define DRV_TP_SPL_NUM_PMU_0094
#define DRV_TP_ADIE_DDIE_STRCUTURE //lxg add for 6250 touch panel
#define DRV_TP_AUXADC_MOVE_TO_ADIE
//#define DRV_TP_AUXADC_MOVE_TO_ADIE_DEBUG
