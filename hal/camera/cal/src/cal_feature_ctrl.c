...
//                                                       pFeatureIn->FeatureInfo.FeatureStructured.pGetJpegSizeEstimationPara->ImageHeight);
            ...
            case CAL_FEATURE_CAMERA_PREVIEW_SIZE:
                if(CAL_FEATURE_QUERY_OPERATION == pFeatureIn->FeatureCtrlCode)
                {
                   P_CAL_CAMERA_GET_PREVIEW_IMAGE_STRUCT pCamGetPreviewImageInPara = ((P_CAL_FEATURE_CTRL_STRUCT)pFeatureOut)->FeatureInfo.FeatureStructured.pCamGetPreviewImageInPara;
		
                   pCamGetPreviewImageInPara->ImageWidth = CurrentSensorInfo.PreviewWidth;
                   pCamGetPreviewImageInPara->ImageHeight = CurrentSensorInfo.PreviewHeight;
                }
                break;
 #endif		
            default:
