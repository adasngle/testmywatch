...
#if (defined(MT6626)||defined(MT6251FM)||defined(MT6276FM)||defined(MT6256FM)||defined(MT6255FM)||defined(MT6250FM) || defined(MT6260FM))
...
#endif
#endif
#if (defined(MT6626)||defined(MT6616)||defined(MT6251FM)||defined(MT6276FM)||defined(MT6256FM)||defined(MT6255FM)||defined(MT6250FM) || defined(MT6260FM))
#define FMR_RAMP_DOWN_SUPPORT/*FM Support ramp down don't need FMR mute*/
#define FMR_NEW_CHIP
#endif
#if (defined(MT6250FM) || defined(MT6260FM))
...
#if (defined(MT6626)||defined(MT6250FM) || defined(MT6260FM))
#define FMR_DSP_CHIP
#endif
