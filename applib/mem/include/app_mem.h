...
__inline void APPLIB_MEM_SET_PATTERN(kal_uint32 *ptr, kal_uint32 pattern)
{
    kal_int32 i;
...
#else /* APPLIB_MEM_GUARDPAT_LEN == 1 */
__inline kal_bool APPLIB_MEM_COMP_PATTERN(const kal_uint32 *ptr, kal_uint32 pattern)
{
    kal_int32 i;
    for (i = 0; i < APPLIB_MEM_GUARDPAT_LEN; i++)
    {
...
extern kal_uint32 applib_mem_ap_get_current_usage_ex(
	...
	kal_bool skip_v10,
	kal_uint16 *skiplist,
	U32 skip_count, app_get_usage_check_cb cb);
