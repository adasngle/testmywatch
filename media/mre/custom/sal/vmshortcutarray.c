...
/* under construction !*/
...
#ifdef __MMI_MRE_APP_MOMAGIC_APPSTORE_SHORTCUT__
    {
        ...
        0,
    #endif
        IMG_ID_AM_APP_MOMAGIC_APPSTORE_SHORTCUT,       /* icon resource id */
        STR_ID_AM_APP_NAME_MOMAGIC_APPSTORE,   /* name resource id */
        "http://appstore.momagic.mobi:9090/asprotocol/UpdateAS",
        0
     },
#endif
