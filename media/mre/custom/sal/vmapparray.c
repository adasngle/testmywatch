...
extern const __align(4) VMUINT8 mre_app_facebook_v2_messenger[];
#endif

#ifdef __MMI_MRE_APP_TWITTER__
extern const __align(4) VMUINT8 mre_app_twitter[];
extern const __align(4) VMUINT8 mre_app_twitter_vsm[];
#endif
...
/* prabhjot: add gameloft games - END */
		...
		mre_buildin_app_array[count++] = (VMUINT8 *)mre_app_facebook_v2_messenger;
		strcpy(mre_buildin_vsm_array[sm_count].file_name,"mre_app_facebook_v2.1");
		mre_buildin_vsm_array[sm_count++].address = (VMUINT) mre_app_facebook_v2;
#endif

#ifdef __MMI_MRE_APP_TWITTER__
		mre_buildin_app_array[count++] = (VMUINT8 *)mre_app_twitter;
        strcpy(mre_buildin_vsm_array[sm_count].file_name,"Twitter_VSM");
        mre_buildin_vsm_array[sm_count++].address = (VMUINT)mre_app_twitter_vsm;
#endif
...
#ifdef __MMI_MRE_APP_CALCULATOR__
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_CALC;
#endif
		
#ifdef __MMI_MRE_APP_CONVERTER__
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_CONV;
#endif
		
#ifdef __MMI_MRE_APP_HEALTH__
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_HEALTH;
#endif
		
#ifdef __MMI_MRE_APP_STOPWATCH__
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_STOPWATCH;
#endif
		
#ifdef __MMI_MRE_APP_OPERA__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_OPERA;
#endif	
	
#if defined(__MMI_MRE_APP_SINA_WEIBO__) && (__MMI_MRE_APP_SINA_WEIBO__ == __MRE_APP_DEFAULT__)
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_WEIBO;
	strcpy(mre_buildin_vsm_array[sm_count].file_name,"weibo");
	mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_WEIBOVSM;
#endif

#ifdef __MMI_MRE_APP_OPERA_MINI_V6__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_OPERA_V6;
#endif

#if defined (__MMI_MRE_APP_3GT_GAME_BALANCE_BALL_CHS__) || defined(__MMI_MRE_APP_3GT_GAME_BALANCE_BALL_CHT__) \
    || defined (__MMI_MRE_APP_3GT_GAME_BALANCE_BALL_ENG__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_3GT_BALL;
#endif

#if defined (__MMI_MRE_APP_3GT_GAME_RASH_MOTOR_CHS__) || defined(__MMI_MRE_APP_3GT_GAME_RASH_MOTOR_CHT__) \
       || defined (__MMI_MRE_APP_3GT_GAME_RASH_MOTOR_ENG__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_3GT_MOTO;
#endif
    
    #if defined (__MMI_MRE_APP_3GT_GAME_BOWLING_ENG__) || defined(__MMI_MRE_APP_3GT_GAME_BOWLING_CHS__) \
        || defined (__MMI_MRE_APP_3GT_GAME_BOWLING_CHT__)
        mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_3GT_BOW;
    #endif
    #if defined (__MMI_MRE_APP_3GT_GAME_DANDELION__)
        mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_3GT_DAN;
    #endif
#if defined(__MMI_MRE_APP_GAMELOFT_CN_PACKAGE1__) || defined(__MMI_MRE_APP_GAMELOFT_GB_PACKAGE1__)
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GL_AS6;
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GL_ACR;
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GL_BBR;
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GL_BCL;
#endif
...
/* prabhjot: add gameloft games - END */
...
#ifdef __MMI_MRE_APP_GAMELOFT_2ND_PACKAGE__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GL_GLLV2;
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GL_MC2;
#endif
...
#ifdef __MMI_MRE_APP_TWITTER__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_TWITTER;
	strcpy(mre_buildin_vsm_array[sm_count].file_name, "Twitter_VSM");
	mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_TWITTER_VSM;
#endif
#if defined(__MMI_MRE_APP_YAHOOMV2__)
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_YMV2;

		strcpy(mre_buildin_vsm_array[sm_count].file_name, "YMv2_VSM");
		mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_YMV2_UI_VSM;
#if !defined (__MRE_SAL_XYSSL__)
		strcpy(mre_buildin_vsm_array[sm_count].file_name, "POLAR_SSL_VSM");
		mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_YMV2_SSL_VSM;
#endif
#endif	

#ifdef __MMI_MRE_APP_FACEBOOK_V2__
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_FBV2;
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_FBV2_MSG;
		strcpy(mre_buildin_vsm_array[sm_count].file_name,"mre_app_facebook_v2.1");
		mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_FBV2;
#endif
	...
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_FBV2_MSG;
	strcpy(mre_buildin_vsm_array[sm_count].file_name,"Facebook_Camera_VSM");
	mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_FBV2_VSM;
	strcpy(mre_buildin_vsm_array[sm_count].file_name,"mre_app_facebook_v2.1");
	mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_FBV2;
#endif

#ifdef __MMI_MRE_APP_YAHOOWEATHER__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_YW;
#endif

#ifdef __MMI_MRE_APP_YAHOOFINANCE__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_YF;
#endif

#ifdef __MMI_MRE_APP_YAHOONEWS__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_YN;
#endif
#ifdef __MMI_MRE_APP_KAIXIN__
#if defined(__MMI_MAINLCD_240X400__)|| defined(__MMI_MAINLCD_320X480__)|| defined(__MMI_MAINLCD_480X800__)
        mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_KAIXIN;
        strcpy(mre_buildin_vsm_array[sm_count].file_name,"kaixin");
        mre_buildin_vsm_array[sm_count++].address = (VMUINT)ENFB_CONTENT_MRE_KAIXINVSM;
#else
        mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_KAIXIN;
#endif
#endif
...
#ifdef __MMI_MRE_APP_YOUKU__
	mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_YOUKU;
#endif

#ifdef __MMI_MRE_APP_WOCHACHA__
        mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_WOCHACHA;        
#endif

#ifdef __MMI_MRE_APP_ZAKAT__
		mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_ZAKAT;
#endif

#if defined(__MMI_MRE_APP_ANGRYBIRDS_EN__) || defined(__MMI_MRE_APP_ANGRYBIRDS_SC__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_ANGRYBIRD;
#endif

#if defined(__MMI_MRE_APP_FISHINGFUN_EN__) || defined(__MMI_MRE_APP_FISHINGFUN_SC__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_FISHINGFUN;
#endif

#if defined(__MMI_MRE_APP_FRUITNINJA_EN__) || defined(__MMI_MRE_APP_FRUITNINJA_SC__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_FRUITNINJA;
#endif

#if defined(__MMI_MRE_GAME_EGYPTCODE_EN__) || defined(__MMI_MRE_GAME_EGYPTCODE_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_EGYPTCODE;
#endif

#if defined(__MMI_MRE_GAME_GIRLSLOT_EN__) || defined(__MMI_MRE_GAME_GIRLSLOT_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GILRSLOT;
#endif

#if defined(__MMI_MRE_GAME_GOLDMINER_EN__) || defined(__MMI_MRE_GAME_GOLDMINER_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_GOLDENMINER;
#endif

#if defined(__MMI_MRE_GAME_HAPPYEGG_EN__) || defined(__MMI_MRE_GAME_HAPPYEGG_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_HAPPYEGG;
#endif

#if defined(__MMI_MRE_GAME_HAPPYWAR_EN__) || defined(__MMI_MRE_GAME_HAPPYWAR_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_HAPPYWAR;
#endif

#if defined(__MMI_MRE_GAME_KINGCOMBAT_EN__) || defined(__MMI_MRE_GAME_KINGCOMBAT_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_KINGCOMBAT;
#endif

#if defined(__MMI_MRE_GAME_MOTO_EN__) || defined(__MMI_MRE_GAME_MOTO_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_MOTO;
#endif

#if defined(__MMI_MRE_GAME_PARKOUR_EN__) || defined(__MMI_MRE_GAME_PARKOUR_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_PARKOUR;
#endif

#if defined(__MMI_MRE_GAME_TEARDRESS_EN__) || defined(__MMI_MRE_GAME_TEARDRESS_CHS__)
    mre_buildin_app_array[count++] = (VMUINT8 *)ENFB_CONTENT_MRE_TEARDRESS;
#endif
