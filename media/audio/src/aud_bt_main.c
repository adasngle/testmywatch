...
extern void aud_bt_open_a2dp_sink_codec_req_hdlr(ilm_struct * ilm_ptr);
extern void aud_bt_start_a2dp_sink_codec_req_hdlr(ilm_struct * ilm_ptr);
extern void aud_bt_stop_a2dp_sink_codec_req_hdlr(ilm_struct * ilm_ptr);
extern void aud_bt_close_a2dp_sink_codec_req_hdlr(ilm_struct * ilm_ptr);
#endif
...
extern void aud_bt_hfp_set_sco_mode_hdlr(ilm_struct *ilm_ptr);
...
kal_bool aud_bt_main(ilm_struct *ilm_ptr)
{
	...
	#ifdef __BT_SPEAKER_SUPPORT__
	    case MSG_ID_MEDIA_BT_OPEN_SINK_CODEC_REQ:
		    aud_bt_open_a2dp_sink_codec_req_hdlr(ilm_ptr);
		    break;
	    case MSG_ID_MEDIA_BT_START_SINK_CODEC_REQ:
		    aud_bt_start_a2dp_sink_codec_req_hdlr(ilm_ptr);
		    break;
        case MSG_ID_MEDIA_BT_STOP_SINK_CODEC_REQ:
            aud_bt_stop_a2dp_sink_codec_req_hdlr(ilm_ptr);
            break;
        case MSG_ID_MEDIA_BT_CLOSE_SINK_CODEC_REQ:
            aud_bt_close_a2dp_sink_codec_req_hdlr(ilm_ptr);
            break;
	#endif
