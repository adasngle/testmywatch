...
extern void aud_fmr_rds_send_event_ind(kal_uint16 event, kal_uint16 flag, kal_uint16 *data, kal_uint16 data_len);
...
extern void aud_send_bt_audio_close_ind(module_type dst_mod_id, kal_uint16 cause);//kal_uint8 profile, kal_uint16 cause);
